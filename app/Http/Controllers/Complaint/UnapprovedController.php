...
class UnapprovedController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.complaint.unapproved.index', compact(array('kode', 'categories', 'main_menu')));
    }
    ...
    public function getunapproved(Request $request)
    {
        ...
        if (!empty($start)) {
            $data = Complaint::select('*')->where(['complaint_status_code' => 'unapproved'])->where(['is_active' => '1']);
        } else {
            $data = Complaint::all();
        }
    ...
    public function show($id)
    {
        ...
        return view('backend.complaint.unapproved.edit', compact(array('data', 'encrypt_id', 'main_menu', 'selectedIDMainMenu', 'categories', 'selectedIDCategories', 'status_code', 'selectedComplaint_status_code')));
    }
