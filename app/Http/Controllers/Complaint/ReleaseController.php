...
class ReleaseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.complaint.release.index', compact(array('kode', 'categories', 'main_menu')));
    }
    ...
    public function getRelease(Request $request)
    {
        ...
        if (!empty($start)) {
            $data = Complaint::select('*')->where(['complaint_status' => 'release'])->where(['is_active' => '1']);
        } else {
            $data = Complaint::all();
        }
    ...
    public function show($id)
    {
        ...
        return view('backend.complaint.release.edit', compact(array('data', 'encrypt_id', 'main_menu', 'selectedIDMainMenu', 'categories', 'selectedIDCategories', 'status_code', 'selectedComplaint_status_code')));
    }
