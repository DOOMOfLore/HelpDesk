    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Datatable Waiting Approval</h3>
            </div>
            ...
            <div class="panel-body">
                <div class="responsive-table">
                    <table id="waitingapproval" class="table table-striped table-bordered" width="100%" cellspacing="0">
                        <thead>
                            <tr>
...
<script type="text/javascript">
    function resetfilter() {
        // Refresh Datatable
        $('#waitingapproval').DataTable().ajax.reload();

        // Remove all filter
        $('#waitingapproval').dataTable().fnFilter('');
    }
    ...
    $("#complaint-menu").show(function() {
        ...
        $('#waitingapproval-menu').addClass('active');
    });

    $(document).ready(function() {
        $('#waitingapproval').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('get-waitingapproval-all') }}",
            columns: [{
                    data: 'complaint_name',
                    name: 'complaint_name'
                },
    ...
    $('#form_create').submit(function(e) {
        ...
        $.ajax({
            url: "{{ route('waiting_approval.store') }}",
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
