        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="responsive-table">
                    <table id="unapproved" class="table table-striped table-bordered" width="100%" cellspacing="0">
                        <thead>
                            <tr>
...
<script type="text/javascript">
    function resetfilter() {
        // Refresh Datatable
        $('#unapproved').DataTable().ajax.reload();

        // Remove all filter
        $('#unapproved').dataTable().fnFilter('');
    }
