    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Datatable Sub Classification</h3>
            </div>
            ...
            <div class="panel-body">
                <div class="responsive-table">
                    <table id="sub_classification" class="table table-striped table-bordered" width="100%" cellspacing="0">
                        <thead>
                            <tr>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Sub Classification Create</h4>
            </div>
            <!-- Modal body -->
            <form id="form_create" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="sub_classification" id="sub_classification" placeholder="Enter Sub Classification" required>
                    </div>
...
<script type="text/javascript">
    function resetfilter() {
        ...
        // Remove all filter
        $('#sub_classification').dataTable().fnFilter('');
    }
    ...
    //Active Class 
    $("#sub_classification-menu").show(function() {
        $('#sub_classification-menu').addClass('active');
        $('#master-menu').addClass('active');
    });

    $(document).ready(function() {
        $('#sub_classification').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('get-sub_classification-all') }}",
            columns: [{
                    data: 'sub_classification_id',
    ...
    $('#form_create').submit(function(e) {
        ...
        $.ajax({
            url: "{{ route('sub_classification.store') }}",
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
