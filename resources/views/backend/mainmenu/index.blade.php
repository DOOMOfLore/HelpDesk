    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Datatable Main Menu</h3>
            </div>
            <div style="padding-top: 10px; padding-right:10px;">
                <button style="float: right; font-weight: 900;" class="btn btn-info btn-sm pr-4" type="button" onclick="resetfilter()">
                    Reset Filter
                </button>
                <button style="float: right; font-weight: 900;" class="btn btn-success btn-sm" type="button" data-toggle="modal" data-target="#CreateMainMenuModal">
                    Create Main Menu
                </button>
            </div>
            ...
            <div class="panel-body">
                <div class="responsive-table">
                    <table id="main_menu" class="table table-striped table-bordered" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>ID Main Menu</th>
                                <th>Main Menu</th>
...
<!-- Create User Modal -->
<div class="modal" id="CreateMainMenuModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Main Menu Create</h4>
            </div>
            <!-- Modal body -->
            <form id="form_create" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="main_menu" id="main_menu" placeholder="Enter Main Menu" required>
                    </div>
...
<script type="text/javascript">
    ...
    //Active Class 
    $("#main_menu-menu").show(function() {
        $('#main_menu-menu').addClass('active');
        ...
        $.ajax({
            ...
            success: function(result) {
                Swal.fire(
                    ...
                    $('#main_menu').DataTable().ajax.reload();
                    $('#CreateMainMenuModal').modal('hide');
                    resetForm();
                });
            },
